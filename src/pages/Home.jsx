...
function Home() {
  ...
  return (
    <>
      <header className="flex items-end justify-center mb-12 h-screen bg-fixed bg-center bg-cover bg-[url('/public/media/home/home-img.gif')]">
        <motion.div animate={animation} transition={transition}>
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={goWelcome}
            className="mt-56 p-8 text-5xl mb-12 font-bold bg-gray-300 bg-opacity-50 rounded-full">
            <CgChevronDoubleDown />
          </motion.button>
        </motion.div>
      </header>
      <div id="welcome" className="max-w-lg m-auto ">
        <p className="mb-4">
